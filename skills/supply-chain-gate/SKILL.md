...
- [ ] **Policy source cited** — `references/policy-allowlist.md` and/or repo `SECURITY.md` (Socket policy section); name the specific Socket alert/finding triaged, not just the policy doc; do not triage by vibes alone
