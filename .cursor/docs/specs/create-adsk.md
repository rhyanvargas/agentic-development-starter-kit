...
**Status:** CLI implemented in [`packages/create-adsk`](../../../packages/create-adsk). **Live on npm** as [`create-adsk`](https://www.npmjs.com/package/create-adsk) (version in [`packages/create-adsk/package.json`](../../../packages/create-adsk/package.json); verify: `./scripts/verify-create-adsk-registry.sh --npx`). Registry publish workflow: [`.github/workflows/publish-create-adsk.yml`](../../../.github/workflows/publish-create-adsk.yml) (OIDC Trusted Publishing). Maintainer runbook: [`docs/RELEASE.md`](../../../docs/RELEASE.md). Bootstrap plan (complete): [`.cursor/plans/create_adsk_npm_first_publish.plan.md`](../../plans/create_adsk_npm_first_publish.plan.md). Product plan: [`.cursor/plans/create-adsk.plan.md`](../../plans/create-adsk.plan.md).
